        ...
        >
          ...
          >
            ...
            <button
              type="button"
              onClick={() => setShowGoogleModal(true)}
              className="w-full h-[52px] flex items-center justify-center gap-3 px-6 text-sm font-extrabold rounded-xl bg-white text-slate-800 border border-slate-300 hover:bg-slate-50 transition-all duration-150 shadow-xs cursor-pointer"
            >
