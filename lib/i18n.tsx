...
const translations: Record<LangCode, Record<string, string>> = {
  en: {
    ...
    // Buyer Portal & Dashboard Extensions
    "buyer.portal": "Verified Recycler (Buyer) Portal",
    "buyer.availableItems": "Available Items",
    "buyer.totalListings": "Total Listings",
    "buyer.categories": "Categories",
    "buyer.cities": "Cities",
    "buyer.searchPlaceholder": "Search by device, brand, or city...",
    "buyer.refresh": "Refresh",
    "buyer.all": "All",
    "buyer.buyBtn": "Buy / Intimate Pickup & Cash",
    "buyer.seller": "Seller",
    "buyer.brand": "Brand",
    "buyer.condition": "Condition",
    "buyer.workingPerfect": "Working — Perfect Condition",
    "buyer.workingMinor": "Working — Minor Issues",
    "buyer.partiallyWorking": "Partially Working",
    "buyer.nonWorking": "Non-working / Damaged",
    "buyer.scrapParts": "Scrap for Parts & Metals",
    "buyer.modalTitle": "Scrap Order & Pickup Intimation",
    "buyer.receiptTitle": "Official Purchase & Pickup Receipt",
    "buyer.intimationAlert": "Pickup Intimation & Order Sent to Seller!",
    "buyer.invoiceTitle": "EcoRoute E-Waste Order Invoice",
    "buyer.collectionToken": "Official Purchase & Doorstep Collection Token",
    "buyer.itemName": "Item Name",
    "buyer.paymentMode": "Payment Mode",
    "buyer.scheduledDate": "Scheduled Pickup Date",
    "buyer.noteForSeller": "Note for Seller",
    "buyer.agreedValue": "Total Agreed Scrap Value",
    "buyer.unlockedAddress": "Unlocked Seller Pickup Address",
    "buyer.mapsNav": "Open Maps Navigation",
    "buyer.callSeller": "Call Seller",
    "buyer.whatsappIntimation": "WhatsApp Intimation",
    "buyer.printToken": "Print / Download Token",
    "buyer.done": "Done",
    "buyer.confirmIntimation": "Confirm & Send Intimation to Seller",
    "buyer.cashOnPickup": "Cash on Pickup",
    "buyer.upiGpay": "UPI / GPay / QR",
    "buyer.cardNetbank": "Card / NetBank",
    "buyer.preferredTime": "Preferred Time Slot",
    "buyer.messageSeller": "Message / Intimation Note for Seller",

    // Dashboard Upload Extensions
    "dashboard.sellTitle": "Sell Your Scrap / E-Waste",
    "dashboard.step1": "Scrap Items",
    "dashboard.step2": "Your Contact Details",
    "dashboard.step3": "Pickup Location",
    "dashboard.fullName": "Full Name",
    "dashboard.mobile": "Mobile Number",
    "dashboard.email": "Email Address",
    "dashboard.whatsapp": "WhatsApp Number",
    "dashboard.streetAddress": "Street Address / Area",
    "dashboard.city": "City",
    "dashboard.pincode": "PIN Code",
    "dashboard.state": "State",
    "dashboard.detectLocation": "Detect My Live Location",
    "dashboard.publishBtn": "Publish Items to Marketplace",
  ...
  ta: {
    ...
    // Buyer Portal & Dashboard Extensions
    "buyer.portal": "சரிபார்க்கப்பட்ட மறுசுழற்சியாளர் தளம்",
    "buyer.availableItems": "கிடைக்கும் பொருட்கள்",
    "buyer.totalListings": "மொத்த பட்டியல்கள்",
    "buyer.categories": "வகைகள்",
    "buyer.cities": "நகரங்கள்",
    "buyer.searchPlaceholder": "சாதனம், பிராண்ட் அல்லது நகரம் தேடுங்கள்...",
    "buyer.refresh": "புதுப்பி",
    "buyer.all": "அனைத்தும்",
    "buyer.buyBtn": "வாங்கு / பிக்கப் & பண அறிவிப்பு",
    "buyer.seller": "விற்பனையாளர்",
    "buyer.brand": "பிராண்ட்",
    "buyer.condition": "நிலை",
    "buyer.workingPerfect": "வேலை செய்கிறது — சிறந்த நிலை",
    "buyer.workingMinor": "வேலை செய்கிறது — சிறு சிக்கல்கள்",
    "buyer.partiallyWorking": "பகுதி வேலை செய்கிறது",
    "buyer.nonWorking": "வேலை செய்யவில்லை / பழுதடைந்தது",
    "buyer.scrapParts": "உதிரிபாகங்கள் & உலோக கழிவு",
    "buyer.modalTitle": "ஈ-கழிவு ஆர்டர் & பிக்கப் அறிவிப்பு",
    "buyer.receiptTitle": "அதிகாரப்பூர்வ வாங்குதல் & பிக்கப் ரசீது",
    "buyer.intimationAlert": "பிக்கப் அறிவிப்பு & ஆர்டர் விற்பனையாளருக்கு அனுப்பப்பட்டது!",
    "buyer.invoiceTitle": "EcoRoute ஈ-கழிவு ஆர்டர் ரசீது",
    "buyer.collectionToken": "அதிகாரப்பூர்வ வாங்குதல் & வீட்டு வாசப் பிக்கப் டோக்கன்",
    "buyer.itemName": "பொருளின் பெயர்",
    "buyer.paymentMode": "பணம் செலுத்தும் முறை",
    "buyer.scheduledDate": "திட்டமிடப்பட்ட பிக்கப் தேதி",
    "buyer.noteForSeller": "விற்பனையாளருக்கான குறிப்பு",
    "buyer.agreedValue": "ஒப்புகொள்ளப்பட்ட மொத்த கழிவு மதிப்பு",
    "buyer.unlockedAddress": "திறக்கப்பட்ட விற்பனையாளர் முகவரி",
    "buyer.mapsNav": "மேப்ஸ் வழிகாட்டுதல்",
    "buyer.callSeller": "விற்பனையாளரை அழைக்கவும்",
    "buyer.whatsappIntimation": "வாட்ஸ்அப் அறிவிப்பு",
    "buyer.printToken": "டோக்கனை அச்சிடு / பதிவிறக்கு",
    "buyer.done": "முடிந்தது",
    "buyer.confirmIntimation": "உறுதிசெய்து விற்பனையாளருக்கு அறிவிக்கவும்",
    "buyer.cashOnPickup": "பிக்கப்பின் போது ரொக்கம்",
    "buyer.upiGpay": "யுபிஐ / ஜிபே / கியூஆர்",
    "buyer.cardNetbank": "கார்டு / நெட்பேங்க்",
    "buyer.preferredTime": "விருப்பமான நேரம்",
    "buyer.messageSeller": "விற்பனையாளருக்கான செய்தி / குறிப்பு",

    // Dashboard Upload Extensions
    "dashboard.sellTitle": "உங்கள் கழிவு / ஈ-கழிவை விளுங்கள்",
    "dashboard.step1": "கழிவு பொருட்கள்",
    "dashboard.step2": "உங்கள் தொடர்பு விவரங்கள்",
    "dashboard.step3": "பிக்கப் இருப்பிடம்",
    "dashboard.fullName": "முழு பெயர்",
    "dashboard.mobile": "கைபேசி எண்",
    "dashboard.email": "மின்னஞ்சல் முகவரி",
    "dashboard.whatsapp": "வாட்ஸ்அப் எண்",
    "dashboard.streetAddress": "தெரு முகவரி / பகுதி",
    "dashboard.city": "நகரம்",
    "dashboard.pincode": "அஞ்சல் குறியீடு",
    "dashboard.state": "மாநிலம்",
    "dashboard.detectLocation": "எனது நேரடி இருப்பிடத்தை கண்டறி",
    "dashboard.publishBtn": "சந்தையில் பொருட்களை வெளியிடவும்",
